...
\section{实验规划与设计}
\subsection{任务分配}
{171860551, \text{韩畅：组长，项目规划，程序框架及大部分功能，主持程序运行调试、优化与提交}}\\ \indent
{171860550, \text{王一之：代码管理，报告撰写，代码注释添加、整理}}\\ \indent
{171860549, \text{闫旭芃：完善部分功能，添加代码注释，报告主体撰写}}\\ \indent
{171840565, \text{李展烁：程序集群运行、调试、优化}}
\subsection{任务要求}
